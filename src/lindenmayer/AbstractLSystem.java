 ...
 * to sequences as </code> Iterator<Symbol></Symbol> </code>. (Note that implementing classes do not
...
public abstract class AbstractLSystem {
     ...
     * @return sequence obtained after rewriting the entire sequence n times
     */
     ...
     * @param n number of rounds
     */
    public abstract void tell(Turtle turtle, Symbol sym, int n);
